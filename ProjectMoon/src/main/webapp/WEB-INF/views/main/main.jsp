...
<h1>메인 화면 이동</h1>
	...
	<a href="../financialStatements/main"><button type="button" id="financialStatementsMain">경제지표</button></a>
	<a href="../company/main"><button type="button" id="companyMain">기업</button></a>
	<a href="../stock/main"><button type="button" id="stockMain">주식</button></a>
